...
public final class ForgeConstants {
    ...
    public static final String VIDEO_DIR                    = RES_DIR + "video" + PATH_SEPARATOR;
    ...
    public static final FileLocation EDITOR_LAYOUT_FILE      = new FileLocation(BASE_SKINS_DIR, USER_PREFS_DIR, "editor.xml");
